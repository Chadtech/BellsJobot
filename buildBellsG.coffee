...
octaves = _.map octaves, (octave, octaveIndex) ->
  _.map octave, (tone, toneIndex) ->
    ...
    seventhHarmonic = gen.sine
      amplitude: a
      tone:      tone * 9.2
      sustain:   bellDuration * 0.12
    sounds.push (eff.fadeOut seventhHarmonic)
    ...
    eighthHarmonic = gen.sine
      ...
      tone:      tone * 9.2
      sustain:   bellDuration * 0.12
    sounds.push (eff.fadeOut eighthHarmonic)
    ...
    ninthHarmonic = gen.sine
      amplitude: a
      tone:      tone * 10.5
      sustain:   bellDuration * 0.11
    sounds.push (eff.fadeOut ninthHarmonic)
    ...
    anotherHarmonic = gen.sine
      amplitude: a
      tone:      tone * 11.7
      sustain:   bellDuration * 0.10
    sounds.push (eff.fadeOut anotherHarmonic)
    ...
    another0Harmonic = gen.sine
      amplitude: a
      tone:      tone * 12.42
      sustain:   bellDuration * 0.9
    sounds.push (eff.fadeOut another0Harmonic)
    ...
    another2Harmonic = gen.sine
      ...
      tone:      tone * 16
      sustain:   bellDuration * 0.6
    sounds.push (eff.fadeOut another2Harmonic)
